...
def test_performance(chatbot, case):
    """OBJECTIVE: Test chatbot responses for Performance in single chatbot session."""
    ...
    # Validate response time based on the max_response_time criteria mentioned in the test data json file
